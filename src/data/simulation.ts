...
export const simulationFormSteps = [
  ...
  },
  {
    id: 'expenses',
    icon: CreditCard,
    title: 'Custos fixos da vida',
    question: 'Quanto você gasta mensalmente com custos fixos (aluguel, contas e etc)?',
    inputProps: {
  ...
  },
  {
    ...
    question: 'Você tem algum valor compremetido com parcelas ou emprestimos mensalmente?',
    inputProps: {
  ...
  },
  {
    ...
    question: 'Em quantos meses você planeja atingit esse objetivo ?',
    inputProps: {
      type: 'number',
      placeholder: 'ex: 12',
      suffix: 'meses',
